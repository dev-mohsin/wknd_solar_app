    ...
    return Container(
      ...
      child: ElevatedButton(
        style: ButtonStyle(
          ...
          elevation: WidgetStateProperty.all(elevation),
          minimumSize: WidgetStateProperty.all<Size>(Size(width, _defaultButtonHeight)),
          backgroundColor: background == null ? WidgetStateProperty.all<Color>(context.primary) : WidgetStateProperty.all<Color>(background!),
          foregroundColor:
              foregroundColor == null ? WidgetStateProperty.all<Color>(context.onPrimary) : WidgetStateProperty.all<Color>(foregroundColor!),
        ),
        onPressed: () {
          if (isProcessing) return;
          if (onPressed != null) onPressed!();
...
class _ShrinkElevatedButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: ElevatedButton(
        style: ButtonStyle(
          fixedSize: WidgetStateProperty.all<Size>(Size(width ?? double.infinity, _defaultButtonHeight)),
          foregroundColor: WidgetStateProperty.all<Color>(context.onPrimary),
          shape: borderRadius == null
              ? WidgetStateProperty.all(
                  const RoundedRectangleBorder(
                    borderRadius: BorderRadius.all(Radius.circular(8.0)),
...
class _SmallButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      overlayColor: WidgetStateProperty.all(context.onPrimary.withOpacity(0.1)),
      child: Container(
        width: 74.0,
        height: 30.0,
